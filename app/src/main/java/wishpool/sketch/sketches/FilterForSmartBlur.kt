...
import wishpool.sketch.sketches.BlurFunctionClass.getByteArrayHelper
    ...
    private fun makeItSmartBlur(
        ...
        for (i3 in 0 until i2) {
            ...
            while (i5 < i) {
                ...
                mArray2[i6] =
                    wishpool.sketch.sketches.RandomColorBalance.getActionMask(((if (f8 == 0.0f) i11.toFloat() else f3 / f8).toDouble() + 0.5).toInt()) or (wishpool.sketch.sketches.RandomColorBalance.getActionMask(
                        ((if (f7 == 0.0f) i10.toFloat() else f2 / f7).toDouble() + 0.5).toInt()
                    ) shl 8 or (wishpool.sketch.sketches.RandomColorBalance.getActionMask((f4.toDouble() + 0.5).toInt()) shl 16 or (wishpool.sketch.sketches.RandomColorBalance.getActionMask(
