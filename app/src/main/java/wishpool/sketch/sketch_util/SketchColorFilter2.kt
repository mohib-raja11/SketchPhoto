    ...
    override fun getSketchFromBH(scaleBitmap: Bitmap): Bitmap {
        ...
        GalleryFileSizeHelper.MakeBitmapForMerge(
            mContext, a2, FilterSizeHelper.getFSHbitmap(
                a2, R.drawable.sketch_6, R.drawable.sketch_6
            ), PorterDuff.Mode.SCREEN
        )
        thresoldHelper.setThresholdValue(120)
        val bitmap3 = thresoldHelper.getThresholdBitmap(a)
        GalleryFileSizeHelper.MakeBitmapForMerge(
            mContext, bitmap3, FilterSizeHelper.getFSHbitmap(
        ...
        GalleryFileSizeHelper.MakeBitmapForMerge(
            mContext, bitmap4, FilterSizeHelper.getFSHbitmap(
                bitmap4, R.drawable.sketch_1, R.drawable.sketch_1
            ), PorterDuff.Mode.SCREEN
        )
        GalleryFileSizeHelper.DrawRectToBitmap(bitmap4, 50.0f)
        GalleryFileSizeHelper.mergeBitmapWithPorterMode(
            bitmap3, bitmap4, PorterDuff.Mode.MULTIPLY
        )
        ...
        GalleryFileSizeHelper.mergeBitmapWithPorterMode(
            bitmap, bitmap4, PorterDuff.Mode.MULTIPLY
        )
        ...
        GalleryFileSizeHelper.mergeBitmapWithPorterMode(
            bitmap4, bitmap, PorterDuff.Mode.SCREEN
        )
