package wishpool.sketch.ui.martinbagica.ui.dialog;
...
public class StrokeSelectorDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        AlertDialog.Builder b = new AlertDialog.Builder(getActivity()).setTitle("Select stroke").setPositiveButton("Ok", new DialogInterface.OnClickListener() {
