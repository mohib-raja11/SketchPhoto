...
public class BitmapFilter {
    ...
    private static final int NEON_STYLE = 5; // neon
    private static final int PIXELATE_STYLE = 6; // pixelate
    private static final int TV_STYLE = 7; // Old TV
    private static final int INVERT_STYLE = 8; // invert the colors
    private static final int BLOCK_STYLE = 9; // engraving
    private static final int OLD_STYLE = 10; // old photo
    private static final int SHARPEN_STYLE = 11; // sharpen
    private static final int LIGHT_STYLE = 12; // light
    private static final int LOMO_STYLE = 13; // lomo
    private static final int HDR_STYLE = 14; // HDR
    private static final int GAUSSIAN_BLUR_STYLE = 15; // gaussian blur
    private static final int SOFT_GLOW_STYLE = 16; // soft glow
    public static final int SKETCH_STYLE = 17; // sketch style
    private static final int MOTION_BLUR_STYLE = 18; // motion blur
    private static final int GOTHAM_STYLE = 19; // gotham style
