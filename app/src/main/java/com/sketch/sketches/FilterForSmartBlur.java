...
public final class FilterForSmartBlur extends ImageFilerName {
    private int smartBlurValue1;
    private int smartBlurValue2;
    private FilterApplyInterface filterApplyInterface;
    private int smartValue3;

    public FilterForSmartBlur(FilterApplyInterface filterApplyInterface) {
        this.smartBlurValue1 = 50;
        this.smartBlurValue2 = 10;
        this.smartValue3 = 0;
            ...
            while (i5 < i) {
                ...
                while (i12 <= a) {
                    ...
                    if (f11 != 0.0f) {
                        ...
                        i7 = mArray[i7 + i4];
                        int i16 = (i7 >> 24) & MotionEventCompat.ACTION_MASK;
                        int i17 = (i7 >> 16) & MotionEventCompat.ACTION_MASK;
                        int i18 = (i7 >> 8) & MotionEventCompat.ACTION_MASK;
                        int i19 = i7 & MotionEventCompat.ACTION_MASK;
                        i7 = i8 - i16;
                        if (i7 >= 0) {
                            if (i7 <= 0) {
                                f9 = f5 + f11;
                ...
                f4 = f6 == 0.0f ? (float) i9 : f / f6;
                mArray2[i6] = RandomColorBalance.getActionMask((int) (((double) (f8 == 0.0f ? (float) i11 : f3 / f8)) + 0.5d)) | ((RandomColorBalance.getActionMask((int) (((double) (f7 == 0.0f ? (float) i10 : f2 / f7)) + 0.5d)) << 8) | ((RandomColorBalance.getActionMask((int) (((double) f4) + 0.5d)) << 16) | (RandomColorBalance.getActionMask((int) (((double) f12) + 0.5d)) << 24)));
                i5++;
                i6 += i2;
            }
